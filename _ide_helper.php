...
')
     ...
     */ 
        ...
        {
                        /** @var \App\Services\AltrpCacheService $instance */
                        return $instance->setUserCookie();
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function saveUserJson($user_id)
        {
                        /** @var \App\Services\AltrpCacheService $instance */
                        return $instance->saveUserJson($user_id);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function removeUserJson($user_id)
        {
                        /** @var \App\Services\AltrpCacheService $instance */
                        return $instance->removeUserJson($user_id);
        }
     ...
     */ 
        ...
        public static function getDriver()
        {
                        /** @var \PulkitJalan\GeoIP\GeoIP $instance */
                        return $instance->getDriver();
        }
                    /**
         * Set ip.
     ...
     */ 
         ...
         * @static 
         */ 
        public static function whereLikeAnd($attributes, $searchTerm)
        {
                        return \Illuminate\Database\Query\Builder::whereLikeAnd($attributes, $searchTerm);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function whereLikeMany($params)
        {
                        return \Illuminate\Database\Query\Builder::whereLikeMany($params);
        }
...
namespace  { 
            ...
            class CacheService extends \App\Altrp\Facades\CacheService {}
            ...
            class GeoIP extends \PulkitJalan\GeoIP\Facades\GeoIP {}
