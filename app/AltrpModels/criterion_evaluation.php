...
class criterion_evaluation extends Model
{
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['criterion_list_id','complete','comment','appeal_id','user_id'];
     ...
     * @var array
     */
    protected $altrp_with = ['appeal','criterion_list','user_altrp'];
    ...
    {
        return $this->belongsTo('App\AltrpModels\criterion_list', 'criterion_list_id', 'id');
    }
