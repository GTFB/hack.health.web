...
class drug_diagnostic_evaluation extends Model
{
    ...
    * @var string
    */
    protected $table = 'drug_diagnostic_evaluations';
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['appeal_id','drug_diagnostic_id','quantity','complete','comment','user_id'];
     ...
     * @var array
     */
    protected $altrp_with = ['appeal','drug_diagnostic','user_altrp'];
    ...
    {
        return $this->belongsTo('App\AltrpModels\drug_diagnostic', 'drug_diagnostic_id', 'id');
    }
