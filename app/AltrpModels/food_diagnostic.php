...
class food_diagnostic extends Model
{
    ...
    * @var string
    */
    protected $table = 'food_diagnostics';
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['diagnostic_id','food_id','frequency','quantity'];
     ...
     * @var array
     */
    protected $altrp_with = ['diagnostic','food'];
    ...
    {
        return $this->belongsTo('App\AltrpModels\food', 'food_id', 'id');
    }

    public function food_diagnostic_evaluation()
    {
        return $this->hasMany('App\AltrpModels\food_diagnostic_evaluation', 'food_diagnostic_id', 'id');
    }
