...
class service_diagnostic_evaluation extends Model
{
    ...
    * @var string
    */
    protected $table = 'service_diagnostic_evaluations';
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['appeal_id','service_diagnostic_id','quantity','complete','comment','user_id'];
