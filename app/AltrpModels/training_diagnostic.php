...
class training_diagnostic extends Model
{
    ...
    * @var string
    */
    protected $table = 'training_diagnostics';
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['diagnostic_id','training_id','frequency','quantity'];
     ...
     * @var array
     */
    protected $altrp_with = ['diagnostic','training'];
    ...
    {
        return $this->belongsTo('App\AltrpModels\training', 'training_id', 'id');
    }
