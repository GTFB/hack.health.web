...
class training_diagnostic_evaluation extends Model
{
    ...
    * @var string
    */
    protected $table = 'training_diagnostic_evaluations';
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['appeal_id','quantity','complete','comment','user_id','training_diagnostic_id'];
     ...
     * @var array
     */
    protected $altrp_with = ['appeal','user_altrp'];
