...
<div class="tab-content">
    ...
    <div class="tab-pane fade show active" id="add_provider">
        <div class="modal-body">
            <form class="data_form" action="<?php echo e(url('/plugins/oauth2/provider_clients')); ?>" method="post">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary save_provider_client" data-method="post" data-url="<?php echo e(url('/plugins/oauth2/provider_clients')); ?>">Save</button>
        </div>
        <script>
...
<?php /**PATH /var/www/hack.medin.cloud/Modules/Oauth2/Resources/views/add_provider_form.blade.php ENDPATH**/ ?>